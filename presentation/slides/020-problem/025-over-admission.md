...
template: diagram
duration: 30
section: Shared listener
marker: Over-admission
transition: fade
---

# Accepted does not always mean capacity.

<p class="fantail-subtitle">The listener can see sockets—not the kind of work inside them or whether a worker can begin it now.</p>
